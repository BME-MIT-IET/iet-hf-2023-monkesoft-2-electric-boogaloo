...
//
//  @ Project : Untitled
//  @ File Name : iet.hf.monkesoft.electric.boogaloo.Reflect.java
//  @ Date : 2022. 03. 23.
//  @ Author :
//
//
...
public class Reflect extends Effect {
	...
	public boolean Protect(Agent a, Virologist v2, Virologist v) {
		...
		//Check, if sender iet.hf.monkesoft.electric.boogaloo.Virologist is null (laboratory can also spread viruses)
