...
//
//  @ Project : Untitled
//  @ File Name : iet.hf.monkesoft.electric.boogaloo.Virologist.java
//  @ Date : 2022. 03. 23.
//  @ Author :
//
//
 ...
 */
	...
	public void AddEffect(AppliedEffect ae) {
		...
		//If it is not, activate a new iet.hf.monkesoft.electric.boogaloo.AppliedEffect
		if(ae.GetTime() < 0) {
			AppliedEffects.add(ae);
		} else { //If there is already an iet.hf.monkesoft.electric.boogaloo.AppliedEffect on the virologist
	...
	public String toString() {
		...
		if(stunned)
		{
			...
			String res =  "\t\t(" + Id + ") Stunned iet.hf.monkesoft.electric.boogaloo.Virologist\n"
					+ "\t\t\tAmino acid: " + amino + "\n"
			...
			return "\t\t(" + Id + ") iet.hf.monkesoft.electric.boogaloo.Virologist";
	}
