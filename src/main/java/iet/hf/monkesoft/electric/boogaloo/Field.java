...
//
//  @ Project : Untitled
//  @ File Name : iet.hf.monkesoft.electric.boogaloo.Field.java
//  @ Date : 2022. 03. 23.
//  @ Author :
//
//
...
public class Field {
	...
	/**
	 * Modified interact, that is called if v has iet.hf.monkesoft.electric.boogaloo.BearConfusion
	 * @param v
	 */
	...
	public String toString() {
		return "\t(" + Id + ") iet.hf.monkesoft.electric.boogaloo.Field";
	}
}
